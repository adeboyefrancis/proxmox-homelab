...
# ============================================================
# HCP Registry Configuration
# Usage - HCP_CLIENT_ID="${var.hcp_client_id}" HCP_CLIENT_SECRET="${var.hcp_client_secret}" packer build -var-file="hcl-secrets.pkrvars.hcl" .
# ============================================================

hcp_packer_registry {
  bucket_name = "hcp-proxmox-image"
  description = "HCP Managed Ubuntu POC Golden Image"
  project_id  = var.hcp_project_id

  bucket_labels = {
    "owner"          = "proxmox-devlab"
    "os"             = "Ubuntu",
    "ubuntu-version" = "Ubuntu 22.04 Server",
    "hyervisor" = "proxmox-ve"
  }
...
variable "template_name" {
  type        = string
  default     = "hcp-ubuntu-image"
  description = "HCP Managed Template"
}

variable "template_description" {
  type        = string
  default     = "HCP Managed Template Ubuntu 22.04 golden image"
  description = "POC Proxmox HCP Registry Image"
}
